...
class PostgresDatabase {
  ...
  async initDatabase() {
    ...
    try {
      ...
      await client.query('DELETE FROM device_commands');
      await client.query('DELETE FROM device_locations');
      await client.query('DELETE FROM devices');
      await client.query('DELETE FROM locations');
      await client.query('DELETE FROM active_users');
      await client.query('DELETE FROM users');

      
      await client.query('ALTER SEQUENCE devices_id_seq RESTART WITH 1');
      await client.query('ALTER SEQUENCE device_commands_id_seq RESTART WITH 1');
      await client.query('ALTER SEQUENCE device_locations_id_seq RESTART WITH 1');
      await client.query('ALTER SEQUENCE locations_id_seq RESTART WITH 1');
      await client.query('ALTER SEQUENCE active_users_id_seq RESTART WITH 1');
      
      console.log('Database formatted - all tables cleared');
